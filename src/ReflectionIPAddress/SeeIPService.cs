...
{
    /// <summary>
    /// Represents a service that retrieves the public IP address of the client using the "seeip.org" service.
    /// </summary>
    public sealed class SeeIPService : IPublicAddressReflectionService
    {
        /// <summary>
        /// Gets the URI of the service.
        /// </summary>
        public Uri ServiceUri => new Uri("https://api.seeip.org/jsonip", UriKind.Absolute);
